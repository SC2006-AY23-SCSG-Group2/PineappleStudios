...
// { success: true, data: { //addSeriesResult, removeSeriesResult, // Uncomment
// to include removal result }, error: {}, }, {status: 200}, ); } catch (error)
// { console.error("Error:", error); return json( { success: false, data: {},
