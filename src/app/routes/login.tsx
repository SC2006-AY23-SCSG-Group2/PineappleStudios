          ...
          <form method="POST" className="rounded-2xl bg-black p-6 w-96">
            ...
            <div className="w-full text-center mt-5">
              <button
                ...
                name="_action"
                value="Sign In"
                className="w-1/2 rounded-xl mt-2 bg-red-500 px-3 py-2 text-black font-semibold transition duration-300 ease-in-out hover:bg-red-600">
                <Link to="/">Login</Link>
              </button>
            </div>
            ...
            <div className="w-full text-center my-1">
              <button
                ...
                name="_action"
                value="Sign In"
                className="w-5/6 rounded-xl mt-2 bg-slate-100 px-3 py-2 text-black font-semibold transition duration-300 ease-in-out hover:bg-slate-300">
                Login with Email
              </button>
            </div>
            <div className="w-full text-center my-1">
