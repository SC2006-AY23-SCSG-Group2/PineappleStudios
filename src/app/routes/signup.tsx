    ...
    <Layout>
      ...
      <div className="flex flex-col gap-y-5">
        <form method="POST" className="rounded-2xl bg-black p-6 w-96">
          <h2 className="text-3xl font-extrabold text-white mb-5">Create an account</h2>
          <Textfield
            htmlFor="name"
            type="name"
            label="Name"
          ...
          <div className="w-full text-center mt-5">
            ...
            <Link to="/"> 
            <button type="submit" name="_action" value="Sign In" className="w-full rounded-xl mt-2 bg-red-500 px-3 py-2 text-black font-semibold transition duration-300 ease-in-out hover:bg-red-600">
              Create an account
            </button>
            </Link>
          </div>
          <p className="text-white mt-4 flex justify-center font-semibold text-lg">
            ...
            <Link to="/login" className="text-red-500 underline hover:text-red-700 font-semibold text-lg">Sign in</Link>
          </p>
        </form>
