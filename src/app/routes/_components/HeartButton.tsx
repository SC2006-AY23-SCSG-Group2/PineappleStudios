...
const HeartButton: FC<{onClick: () => void}> = ({onClick}) => {
  return (
    <button
      onClick={onClick}
      className="absolute right-2 bottom-2 flex h-5 w-5 items-center justify-center rounded-full bg-pink-200">
      <svg className="fill-current text-pink-500" width="30px" height="30px" viewBox="0 0 50 50" xmlns="http://www.w3.org/2000/svg">
