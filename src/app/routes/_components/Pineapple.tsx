export default function Pineapple() {
    return (
      <div className="inline-block">
        <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" height={20} width={20}
             viewBox="0 0 100.846 100.846" enableBackground="new 0 0 100.846 100.846" xmlSpace="preserve">
          <g>
            <g>
